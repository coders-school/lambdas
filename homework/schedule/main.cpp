...
// Napisz również przeciążenie funkcji schedule(), które oprócz okresu czasu ma przyjąć dowolną funkcję, która przyjmuje int i nic nie zwraca. 
// Pomyśl jak przekazać ten argument int do tej funkcji.
